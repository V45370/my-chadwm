...
static const unsigned int gappih    = 5;       /*10 horiz inner gap between windows */
static const unsigned int gappiv    = 5;       /*10 vert inner gap between windows */
static const unsigned int gappoh    = 5;       /*10 horiz outer gap between windows and screen edge */
static const unsigned int gappov    = 5;       /*10 vert outer gap between windows and screen edge */
...
#define ICONSIZE 10   /*19 icon size */
#define ICONSPACING 8 /* space between icon and title */

//static const char *fonts[]          = {"Iosevka:style:medium:size=30" ,"JetBrainsMono Nerd Font:style:medium:size=30",
static const char *fonts[]          = {"JetBrainsMono Nerd Font:style:medium:size=10"};
//                                        "Material Design Icons Desktop:size=20" };
//                                        "Material Design Icons Desktop:size=40" };*/
